...
namespace TelCo.ColorCoder
{
    ...
    static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            int pairNumber = 4;
            ColorPair testPair1 = GetColorFromPairNumber_Type.GetColorFromPairNumber(pairNumber);
            Console.WriteLine("[In]Pair Number: {0},[Out] Colors: {1}\n", pairNumber, testPair1);
            Debug.Assert(testPair1.majorColor == Color.White);
            Debug.Assert(testPair1.minorColor == Color.Brown);

            pairNumber = 5;
            testPair1 = GetColorFromPairNumber_Type.GetColorFromPairNumber(pairNumber);
            Console.WriteLine("[In]Pair Number: {0},[Out] Colors: {1}\n", pairNumber, testPair1);
            Debug.Assert(testPair1.majorColor == Color.White);
            ...
            pairNumber = GetPairNumberFromColor_Type.GetPairNumberFromColor(testPair2);
